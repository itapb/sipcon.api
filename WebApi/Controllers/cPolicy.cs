...
namespace WebApi.Controllers
{
    ...
    public class cPolicy : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAll(string? filter, Int32 rowFrom, Int32 userId, Int32? dealerId)
        {
            ...
            try
            {
                var _response = await _dPolicy.GetAll(filter, rowFrom, userId,dealerId);
        ...
        //        List<Policy> _policies = await _dPolicy.GetExport(filter, userId,dealerId);
        ...
        //    try
        //    {
        //        var response = await _dPolicy.GetOne(policyId, userId);
