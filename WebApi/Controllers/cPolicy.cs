...
namespace WebApi.Controllers
{
    ...
    public class cPolicy : ControllerBase
    {
        ...
        [HttpGet("GetAll")]
        public async Task<IActionResult> GetAll(string? filter, Int32 rowFrom, Int32 userId, Int32? dealerId)
        {

            try
            {
                Response _response = await _dPolicy.GetAll(filter, rowFrom, userId,dealerId);
        ...
        public async Task<IActionResult> GetOneBy(Int32 userId, string filter, Int32 filterBy)
        {
            ...
            try
            {
                Models.Response _response = await _dPolicy.GetOneBy(userId, filter, filterBy);
                return StatusCode(_response.Status, _response);
            }
            catch (Exception ex)
            {
        ...
        private MemoryStream ConvertToExcel(List<Models.PolicyExtended> _policies)
        {
        ...
        [HttpGet("Export")]
        public async Task<IActionResult> GetExport(string? filter, Int32 userId, Int32? dealerId)
        {

            try
            {

                List<PolicyExtended> _policies = await _dPolicy.GetExport(filter, userId,dealerId);
        ...
        public async Task<IActionResult> GetExportPdf(Int32 userId, Int32 policyId)
        {
            try
            {
                Response response = await _dPolicy.GetOne(policyId, userId);
                ...
                else if (response.Data is JArray jsonArray)
                {
                    ...
                    policies = jsonArray.ToObject<List<PolicyExtended>>();
                }
                else
                {
                    ...
                    container.Page(firstPage =>
                    {
                        ...
                        firstPage.Content().AlignCenter().Column(column =>
                        {
                            column.Item().AlignCenter().Table(table =>
                            {
                                ...
                                Con su firma el comprador declara que se ha recibido el original de esta póliza de garantía, que la misma se encuentra libre de enmiendas, tachaduras o borrones, acepta sus términos y condiciones establecidos bajo el título de garantía del vehículo, y confirma que conjuntamente con ella, ha recibido el manual de propietario del vehículo antes mencionado.{Environment.NewLine}{Environment.NewLine}DATOS DEL VEHÍCULO{Environment.NewLine}SERIAL DE CARROCERÍA (VIN):{Environment.NewLine}{policy.Vin}{Environment.NewLine}SERIAL DE MOTOR:{Environment.NewLine}{policy.EngineSerial}{Environment.NewLine}MODELO:{Environment.NewLine}{policy.ModelName}{Environment.NewLine}AÑO MODELO:{Environment.NewLine}{policy.Year}{Environment.NewLine}PLACA:{Environment.NewLine}{policy.Plate}{Environment.NewLine}COLOR:{Environment.NewLine}{policy.Color}{Environment.NewLine}FECHA DE VENTA:{Environment.NewLine}{policy.ActivationDate}{Environment.NewLine}{Environment.NewLine}                                                       ___________________________________________________________________{Environment.NewLine}                 SELLO Y FIRMA DEL CONCESIONARIO AUTORIZADO").FontSize(7.6f).Justify();
                            });
                                                });
                                            });
        ...
        public async Task<IActionResult> GetOne(Int32 userId,  Int32 policyId)
        {
            ...
            try
            {
                ...
                Models.Response _response = await _dPolicy.GetOne(policyId, userId);
                return StatusCode(_response.Status, _response);
        ...
        public async Task<IActionResult> GetOnePolicyDetails(Int32 policyId, Int32 km,DateTime date)
        {
            try
            {
                ...
                Models.Response _response = await _dPolicy.GetOnePolicyDetails(policyId,km,date);
                return StatusCode(_response.Status, _response);
        ...
        public async Task<IActionResult> GetPolicyDetails(Int32 policyId)
        {
            try
            {
                ...
                Models.Response _response = await _dPolicy.GetPolicyDetails(policyId);
                return StatusCode(_response.Status, _response);
        ...
        public async Task<IActionResult> GetLogPolicyDetails(Int32 policyId)
        {
            try
            {
                ...
                Models.Response _response = await _dPolicy.GetLogPolicyDetails(policyId);
                return StatusCode(_response.Status, _response);
        ...
        public async Task<IActionResult> Post_Policy(Int32 userId, Models.Policy policy)
        {
            ...
            try
            {
               Models.Response _response  = await _dPolicy.Post_Policy(policy, userId);
                return StatusCode(_response.Status, _response);
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> Post_Actions(Int32 userId, List<Models.Action> actions)
        {
            ...
            try
            {
                ...
                Models.Response _response = await _dPolicy.Post_Actions(actions, userId);
                return StatusCode(_response.Status, _response);
