...
namespace Data
{
    public class dInventory
    {
        ...
        public async Task<Response<List<MovementDetails>>> GetMovementDetailsTransfer(Int32 userId, Int32? supplierId, Int32? rowfrom, string? filter, bool? pending, DateTime? fromDate, DateTime? upToDate, int? estatusId)
        {
            await _semaphore.WaitAsync(Util.Setting.TimeOut);
            try
            {
                return await _getMovementDetailsTransfer(userId, supplierId, rowfrom, filter, pending, fromDate, upToDate, estatusId);
            }
            finally
            {
                _semaphore.Release();
        ...
        private async Task<Response<List<MovementDetails>>> _getMovementDetailsTransfer(Int32 userId, Int32? supplierId, Int32? rowfrom, string? filter, bool? pending, DateTime? fromDate, DateTime? upToDate, int? estatusId)
        {
            Response<List<MovementDetails>> _response = new Response<List<MovementDetails>>();
            try
            {
       ...
       //------------------------------------------------------------------POST ACTIONS DETAILS-------------------------------------------------------------------------
        ...
        public async Task<Response<List<GetInventoryCountDetail>>> GetInventoryCountDetailByForm(Int32 userId, Int32? supplierId, int inventoryCountId, int formId, Int32? rowfrom)
        {
            await _semaphore.WaitAsync(Util.Setting.TimeOut);
            try
            {
                return await _GetInventoryCountDetailByForm(userId, supplierId, inventoryCountId, formId, rowfrom );
            }
            finally
            {
                _semaphore.Release();
        ...
        private async Task<Response<List<GetInventoryCountDetail>>> _GetInventoryCountDetailByForm(Int32 userId, Int32? supplierId, int inventoryCountId, int formId, Int32? rowfrom)
        {
            Response<List<GetInventoryCountDetail>> _response = new Response<List<GetInventoryCountDetail>>();
            try
            {
